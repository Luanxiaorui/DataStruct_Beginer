...
public class PlaneManage  extends  JPanel implements ActionListener {
    ...
    JTable t;
    Object[][] row;
    Object[] colum = { "出发站", "到达站", "出发时间", "到站时间", "航班号","花费" };

    PlaneManage( AdjacentList graph) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == jb1) {
            ...
            else if (graph.delete(tf1.getText(), tf2.getText(), tf5.getText(),1)) {
        ...
        // 触发查询
            ...
            if(tf5.getText().isEmpty()&&tf1.getText().isEmpty()&&tf2.getText().isEmpty())
                ...
                row=graph.getInformation(tf5.getText(),tf1.getText(),tf2.getText(),1);
                updateTable("survey");
            }
        ...
        // 触发更新
            ...
            if(tf1.getText().isEmpty()||tf2.getText().isEmpty()||tf5.getText().isEmpty()||tf6.getText().isEmpty()||tf3.getText().isEmpty()||tf4.getText().isEmpty())
                JOptionPane.showMessageDialog(null, "信息不全", "提示", JOptionPane.PLAIN_MESSAGE);
            else {
                graph.updateInformation(tf1.getText(), tf2.getText(), tf5.getText(), tf6.getText(), tf3.getText(), tf4.getText(), 1);
                updateTable("update");
            }
        }
            ...
            if(tf1.getText().isEmpty()&&tf2.getText().isEmpty())
                ...
                graph.AddFrm(tf1.getText(), tf2.getText(), tf3.getText(), tf4.getText(), tf5.getText(), tf6.getText(),1);
                updateTable("");
            }
        }
    }
